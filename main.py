...
cqhttp_url = "http://127.0.0.1:8700"  # CQ-http地址
qq_no = "" # 机器人QQ号，记得修改
config = {
    "session_token":""
}
...
def chat(msg):
    ...
    while i < 3:
        try:
            message = chatbot.ask(msg,conversation_id = chatbot.config.get("conversation"))['message']
            ...
            time.sleep(80)
            i += 1
    return str('Sorry网络延迟，请稍后重新把问题@我一下！')
